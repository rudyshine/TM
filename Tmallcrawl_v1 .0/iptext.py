...
def get_random_ip(ip_list,url1):
    ...
    html = requests.get(url3, headers=headers, timeout=10,proxies = proxies).text
    return html
...
if __name__ == '__main__':
    ...
    url3="https://gree.tmall.com/category-1290118897.htm?spm=a1z10.1-b-s.w10971653-16352291479.30.4WCdHD&search=y" \
         "&scene=taobao_shop#TmshopSrchNav"
    # headers = {
